...
export const getCurrencyRate = () => {
  return dispatch => {
    let date = new Date(),
        currentDate = `${date.getDate() < 10 ? '0' + date.getDate() : date.getDate()}/${date.getMonth() 
...
export const changeDate = (date) => {
  return dispatch => {
    let chosenDate = `${date._d.getDate() < 10 ? '0' + date._d.getDate() : date._d.getDate()}/${date._d.getMonth() 
                      < 10 ? '0' + date._d.getMonth() : date._d.getMonth()}/${date._d.getFullYear()}`;
